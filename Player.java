...
public class Player extends Arena {
    ...
    /**
    Die Methode ueberprueft anhand der noch im Spielfeld vorhandenen Schiffe
    ob der Spieler noch am Leben ist.
    @return Gibt false zurück, wenn der Spieler verloren hat ansonsten true
    */
    ...
    /**
    Die Methode entspricht der set-Methode für das Attribut grid der Klasse Player.
    Es ueberprueft ob der gegnerische Schuss ein Treffer war und vermerkt diesen im Spielfeld.
    @param row Zeile des gegnerischen Schusses
    @param col Spalte des gegnerischen Schusses 
    @return true falls Treffer, false falls kein Treffer
    */
